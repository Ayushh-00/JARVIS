...
* Assisting with productivity through note-taking
...
* Web and app shortcuts
* Weather updates
* A simple note system
* Experimental camera-based features

The project is modular, so new features can be added at any point.
...
More features and improvements can always be added based on preference and creativity.
